...
To use something in anger, is an idiom for: when something has been
...
to the most recent name in the \file{bib} is desired.  The tag is
...
provides: separation of concerns, a clean \file{bib} and allows
...
If the \file{bib} construct forum names using strings, as in
