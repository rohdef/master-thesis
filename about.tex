...
with $OPT$.  It is so widely used that it is common to see article
search engines have tags that are not specified by {\bibtex} and there
are libraries that provide citing styles that make use of these tags.
